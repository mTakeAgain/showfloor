...
static const LevelScript script_func_local_1[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  2013,  768, -4274, /*angle*/ 0,    0, 0, /*bhvParam*/ 0x000A0000, /*bhv*/ bhvWarp),
    WARP_NODE(/*id*/ 0x0A, /*destLevel*/ LEVEL_PSS, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/    0,  178,  -6105, /*angle*/ 0,    0, 0, /*bhvParam*/ 0x300B0000, /*bhv*/ bhvWarp),
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -1024,  512, -2910, /*angle*/ 0,    0, 0, /*bhvParam*/ 0x001E0000, /*bhv*/ bhvInstantActiveWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/     0,   0, -1920, /*angle*/ 0,  180, 0, /*bhvParam*/ 0x001F0000, /*bhv*/ bhvInstantActiveWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -1024,  900, -1543, /*angle*/ 0,  180, 0, /*bhvParam*/ 0x00200000, /*bhv*/ bhvAirborneWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -1024,  900, -1543, /*angle*/ 0,  180, 0, /*bhvParam*/ 0x00210000, /*bhv*/ bhvAirborneDeathWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -1024,  900, -1543, /*angle*/ 0,  180, 0, /*bhvParam*/ 0x00220000, /*bhv*/ bhvHardAirKnockBackWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -1024,  900, -1543, /*angle*/ 0,  180, 0, /*bhvParam*/ 0x00230000, /*bhv*/ bhvDeathWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/     0,  384, -6105, /*angle*/ 0,  180, 0, /*bhvParam*/ 0x00240000, /*bhv*/ bhvLaunchStarCollectWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/     0,  384, -6105, /*angle*/ 0,  180, 0, /*bhvParam*/ 0x00250000, /*bhv*/ bhvLaunchDeathWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -1024,  900, -1543, /*angle*/ 0,    0, 0, /*bhvParam*/ 0x00260000, /*bhv*/ bhvAirborneStarCollectWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  2816, 1200, -2516, /*angle*/ 0,   90, 0, /*bhvParam*/ 0x00270000, /*bhv*/ bhvAirborneStarCollectWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  2816, 1200, -2516, /*angle*/ 0,  270, 0, /*bhvParam*/ 0x00280000, /*bhv*/ bhvDeathWarp),
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -3208, 717, -2225, /*angle*/ 0, -90, 0, /*bhvParam*/ 0x00320000, /*bhv*/ bhvPaintingStarCollectWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  -948, 102, -4505, /*angle*/ 0, 180, 0, /*bhvParam*/ 0x00330000, /*bhv*/ bhvPaintingStarCollectWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/   948, 102, -4505, /*angle*/ 0, 180, 0, /*bhvParam*/ 0x00340000, /*bhv*/ bhvPaintingStarCollectWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  3208, 717, -2225, /*angle*/ 0,  90, 0, /*bhvParam*/ 0x00350000, /*bhv*/ bhvPaintingStarCollectWarp),
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -3208, 717, -2225, /*angle*/ 0, -90, 0, /*bhvParam*/ 0x00640000, /*bhv*/ bhvPaintingDeathWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  -948, 102, -4505, /*angle*/ 0, 180, 0, /*bhvParam*/ 0x00650000, /*bhv*/ bhvPaintingDeathWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/   948, 102, -4505, /*angle*/ 0, 180, 0, /*bhvParam*/ 0x00660000, /*bhv*/ bhvPaintingDeathWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  3208, 717, -2225, /*angle*/ 0,  90, 0, /*bhvParam*/ 0x00670000, /*bhv*/ bhvPaintingDeathWarp),
...
const LevelScript level_castle_inside_entry[] = {
    ...
    AREA(/*index*/ 1, castle_geo),
        OBJECT(/*model*/ MODEL_NONE,              /*pos*/    0, 615,-6105, /*angle*/ 0,   0, 0, /*bhvParam*/ 0x00140000, /*bhv*/ bhvCastleFloorTrap),
        OBJECT(/*model*/ MODEL_CASTLE_DOOR_A,     /*pos*/-1689, 205, -2225, /*angle*/ 0,  90, 0, /*bhvParam*/ 0x00000000, /*bhv*/ bhvDoor),
        OBJECT(/*model*/ MODEL_CASTLE_DOOR_B,     /*pos*/-948,   0, -2966, /*angle*/ 0,   0, 0, /*bhvParam*/ 0x00000000, /*bhv*/ bhvDoor),
        OBJECT(/*model*/ MODEL_CASTLE_DOOR_C,     /*pos*/  944,   0, -2966, /*angle*/ 0,   0, 0, /*bhvParam*/ 0x00000000, /*bhv*/ bhvDoor),
        OBJECT(/*model*/ MODEL_CASTLE_DOOR_D,     /*pos*/ 1685, 205, -2224, /*angle*/ 0, -90, 0, /*bhvParam*/ 0x00000000, /*bhv*/ bhvDoor),
        OBJECT(/*model*/ MODEL_CASTLE_DOOR,       /*pos*/ -330,   0, -2758, /*angle*/ 0, -45, 0, /*bhvParam*/ 0x00000000, /*bhv*/ bhvDoor),
        OBJECT(/*model*/ MODEL_CASTLE_DOOR,       /*pos*/  330,   0, -2758, /*angle*/ 0,  45, 0, /*bhvParam*/ 0x00000000, /*bhv*/ bhvDoor),
        OBJECT(/*model*/ MODEL_CASTLE_DOOR,       /*pos*/  -78, 410, -2966, /*angle*/ 0,   0, 0, /*bhvParam*/ 0x00010000, /*bhv*/ bhvDoor),
        OBJECT(/*model*/ MODEL_CASTLE_DOOR,       /*pos*/   75, 410, -2966, /*angle*/ 0,-180, 0, /*bhvParam*/ 0x00020000, /*bhv*/ bhvDoor),
        OBJECT(/*model*/ MODEL_CASTLE_DOOR,       /*pos*/  -79,   0, -1023, /*angle*/ 0,   0, 0, /*bhvParam*/ 0x00000000, /*bhv*/ bhvDoorWarp),
        OBJECT(/*model*/ MODEL_CASTLE_DOOR,       /*pos*/   75,   0, -1023, /*angle*/ 0,-180, 0, /*bhvParam*/ 0x00010000, /*bhv*/ bhvDoorWarp),
        OBJECT(/*model*/ MODEL_CASTLE_DOOR,       /*pos*/    0,   0, -5391, /*angle*/ 0,   0, 0, /*bhvParam*/ 0x00020000, /*bhv*/ bhvDoorWarp),
